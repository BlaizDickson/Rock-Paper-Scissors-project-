...
function compareStrings(computerChoice, playerSelection) {
...
//var result = compareStrings(randomString, playerSelection);
...
for (var i = 0; i < 5; i++) {
  ...
  // Get the user input
  var playerSelection = prompt('Enter a your choice (Rock, Paper, Scissors):');
